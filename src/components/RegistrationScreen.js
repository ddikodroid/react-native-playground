...
const RegistrationScreen = ({navigation}) => {
    ...
    return (
        ...
        <View>
            ...
            <TextInput value={nama} onChangeText={(txt) => setNama(txt)}/>
            <Text>Input Usia: </Text>
            <TextInput value={usia} onChangeText={(txt) => setUsia(txt)}/>
            <Text>Input Alamat: </Text>
            <TextInput value={alamat} onChangeText={(txt) => setAlamat(txt)}/>
        </View>
